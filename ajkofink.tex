...
% action against female contributors may be statistically neutralized.
% Static analysis tools could be used on the commit content of each pull request gathered
